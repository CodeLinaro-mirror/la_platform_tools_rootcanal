...
void LeController::SetLocalName(std::array<uint8_t, kLocalNameSize> const& local_name) {
  std::copy(local_name.begin(), local_name.end(), local_name_.begin());
}

void LeController::SetLocalName(std::vector<uint8_t> const& local_name) {
  ASSERT(local_name.size() <= local_name_.size());
  local_name_.fill(0);
  std::copy(local_name.begin(), local_name.end(), local_name_.begin());
}

void LeController::SetExtendedInquiryResponse(
...
void LeController::SendLinkLayerPacket(
        std::unique_ptr<model::packets::LinkLayerPacketBuilder> packet, int8_t tx_power) {
  std::shared_ptr<model::packets::LinkLayerPacketBuilder> shared_packet = std::move(packet);
  ScheduleTask(kNoDelayMs, [this, shared_packet, tx_power]() {
...
ErrorCode LeController::SendCommandToRemoteByAddress(OpCode opcode, pdl::packet::slice args,
...
ErrorCode LeController::SendCommandToRemoteByHandle(OpCode opcode, pdl::packet::slice args,
                                                    uint16_t handle) {
...
ErrorCode LeController::SendScoToRemote(bluetooth::hci::ScoView sco_packet) {
...
void LeController::IncomingPacket(model::packets::LinkLayerPacketView incoming, Phy::Type phy,
                                  int8_t rssi) {
...
void LeController::IncomingBrEdrPacket(model::packets::LinkLayerPacketView incoming, int8_t rssi) {
...
void LeController::IncomingLePacket(model::packets::LinkLayerPacketView incoming, int8_t rssi) {
  auto destination_address = incoming.GetDestinationAddress();
  auto source_address = incoming.GetSourceAddress();
...
void LeController::IncomingAclPacket(model::packets::LinkLayerPacketView incoming, int8_t rssi) {
...
void LeController::IncomingScoPacket(model::packets::LinkLayerPacketView incoming) {
...
void LeController::IncomingRemoteNameRequest(model::packets::LinkLayerPacketView incoming) {
...
void LeController::IncomingRemoteNameRequestResponse(model::packets::LinkLayerPacketView incoming) {
...
void LeController::IncomingReadRemoteLmpFeatures(model::packets::LinkLayerPacketView incoming) {
...
void LeController::IncomingReadRemoteLmpFeaturesResponse(
        model::packets::LinkLayerPacketView incoming) {
...
void LeController::IncomingReadRemoteSupportedFeatures(
        model::packets::LinkLayerPacketView incoming) {
...
void LeController::IncomingReadRemoteSupportedFeaturesResponse(
        model::packets::LinkLayerPacketView incoming) {
...
void LeController::IncomingReadRemoteExtendedFeatures(
        model::packets::LinkLayerPacketView incoming) {
...
void LeController::IncomingReadRemoteExtendedFeaturesResponse(
        model::packets::LinkLayerPacketView incoming) {
...
void LeController::IncomingReadClockOffset(model::packets::LinkLayerPacketView incoming) {
...
void LeController::IncomingReadClockOffsetResponse(model::packets::LinkLayerPacketView incoming) {
...
void LeController::IncomingDisconnectPacket(model::packets::LinkLayerPacketView incoming) {
...
void LeController::IncomingInquiryPacket(model::packets::LinkLayerPacketView incoming,
                                         uint8_t rssi) {
...
void LeController::IncomingInquiryResponsePacket(model::packets::LinkLayerPacketView incoming) {
...
void LeController::IncomingScoConnectionRequest(model::packets::LinkLayerPacketView incoming) {
...
void LeController::IncomingScoConnectionResponse(model::packets::LinkLayerPacketView incoming) {
  Address address = incoming.GetSourceAddress();
  ...
  if (status == ErrorCode::SUCCESS) {
    ...
    connections_.AcceptPendingScoConnection(address, link_parameters, [this, address] {
      return LeController::StartScoStream(address);
    });
...
void LeController::IncomingScoDisconnect(model::packets::LinkLayerPacketView incoming) {
  Address address = incoming.GetSourceAddress();
...
void LeController::IncomingLmpPacket(model::packets::LinkLayerPacketView incoming) {
  Address address = incoming.GetSourceAddress();
...
void LeController::IncomingPagePacket(model::packets::LinkLayerPacketView incoming) {
...
void LeController::IncomingPageRejectPacket(model::packets::LinkLayerPacketView incoming) {
  auto bd_addr = incoming.GetSourceAddress();
...
void LeController::IncomingPageResponsePacket(model::packets::LinkLayerPacketView incoming) {
  auto bd_addr = incoming.GetSourceAddress();
...
void LeController::RegisterScoChannel(
...
void LeController::ForwardToLm(bluetooth::hci::CommandView command) {
...
std::vector<bluetooth::hci::Lap> const& LeController::ReadCurrentIacLap() const {
  return current_iac_lap_list_;
}

void LeController::WriteCurrentIacLap(std::vector<bluetooth::hci::Lap> iac_lap) {
...
ErrorCode LeController::AcceptConnectionRequest(const Address& bd_addr, bool try_role_switch) {
  ...
  if (connections_.HasPendingScoConnection(bd_addr)) {
    ...
    if (!connections_.AcceptPendingScoConnection(bd_addr, connection_parameters, [this, bd_addr] {
          return LeController::StartScoStream(bd_addr);
        })) {
...
void LeController::MakePeripheralConnection(const Address& bd_addr, bool try_role_switch) {
  uint16_t connection_handle = connections_.CreateConnection(bd_addr, GetAddress());
...
ErrorCode LeController::RejectConnectionRequest(const Address& addr, uint8_t reason) {
...
void LeController::RejectPeripheralConnection(const Address& addr, uint8_t reason) {
...
ErrorCode LeController::CreateConnection(const Address& bd_addr, uint16_t /* packet_type */,
...
ErrorCode LeController::CreateConnectionCancel(const Address& bd_addr) {
...
ErrorCode LeController::ChangeConnectionPacketType(uint16_t handle, uint16_t types) {
  if (!connections_.HasAclHandle(handle)) {
    return ErrorCode::UNKNOWN_CONNECTION;
  }
...
ErrorCode LeController::ChangeConnectionLinkKey(uint16_t handle) {
  if (!connections_.HasAclHandle(handle)) {
    return ErrorCode::UNKNOWN_CONNECTION;
  }
...
// NOLINTNEXTLINE(readability-convert-member-functions-to-static)
ErrorCode LeController::CentralLinkKey(uint8_t /* key_flag */) {
  // TODO: implement real logic
  return ErrorCode::COMMAND_DISALLOWED;
}

ErrorCode LeController::HoldMode(uint16_t handle, uint16_t hold_mode_max_interval,
...
ErrorCode LeController::SniffMode(uint16_t handle, uint16_t sniff_max_interval,
...
ErrorCode LeController::ExitSniffMode(uint16_t handle) {
  if (!connections_.HasAclHandle(handle)) {
    return ErrorCode::UNKNOWN_CONNECTION;
  }
...
ErrorCode LeController::QosSetup(uint16_t handle, uint8_t service_type, uint32_t /* token_rate */,
...
ErrorCode LeController::RoleDiscovery(uint16_t handle, bluetooth::hci::Role* role) {
  if (!connections_.HasAclHandle(handle)) {
    return ErrorCode::UNKNOWN_CONNECTION;
  }
...
ErrorCode LeController::SwitchRole(Address bd_addr, bluetooth::hci::Role role) {
...
void LeController::IncomingRoleSwitchRequest(model::packets::LinkLayerPacketView incoming) {
  auto bd_addr = incoming.GetSourceAddress();
  auto connection_handle = connections_.GetAclConnectionHandle(bd_addr);
...
void LeController::IncomingRoleSwitchResponse(model::packets::LinkLayerPacketView incoming) {
  auto bd_addr = incoming.GetSourceAddress();
  auto connection_handle = connections_.GetAclConnectionHandle(bd_addr);
...
ErrorCode LeController::ReadLinkPolicySettings(uint16_t handle, uint16_t* settings) {
  if (!connections_.HasAclHandle(handle)) {
    return ErrorCode::UNKNOWN_CONNECTION;
  }
...
ErrorCode LeController::WriteLinkPolicySettings(uint16_t handle, uint16_t settings) {
  if (!connections_.HasAclHandle(handle)) {
    return ErrorCode::UNKNOWN_CONNECTION;
  }
...
ErrorCode LeController::WriteDefaultLinkPolicySettings(uint16_t settings) {
  if (settings > 7 /* Sniff + Hold + Role switch */) {
    return ErrorCode::INVALID_HCI_COMMAND_PARAMETERS;
  }
...
uint16_t LeController::ReadDefaultLinkPolicySettings() const {
  return default_link_policy_settings_;
}

void LeController::ReadLocalOobData() {
...
void LeController::ReadLocalOobExtendedData() {
...
ErrorCode LeController::FlowSpecification(uint16_t handle, uint8_t flow_direction,
...
ErrorCode LeController::WriteLinkSupervisionTimeout(uint16_t handle, uint16_t /* timeout */) {
  if (!connections_.HasAclHandle(handle)) {
    return ErrorCode::UNKNOWN_CONNECTION;
  }
  return ErrorCode::SUCCESS;
...
bool LeController::HasAclConnection(uint16_t connection_handle) {
...
void LeController::StartInquiry(milliseconds timeout) {
  inquiry_timer_task_id_ =
          ScheduleTask(milliseconds(timeout), [this]() { LeController::InquiryTimeout(); });
}

void LeController::InquiryCancel() {
  ASSERT(inquiry_timer_task_id_ != kInvalidTaskId);
  CancelScheduledTask(inquiry_timer_task_id_);
  inquiry_timer_task_id_ = kInvalidTaskId;
}

void LeController::InquiryTimeout() {
  if (inquiry_timer_task_id_ != kInvalidTaskId) {
    inquiry_timer_task_id_ = kInvalidTaskId;
...
void LeController::SetInquiryMode(uint8_t mode) {
  inquiry_mode_ = static_cast<model::packets::InquiryType>(mode);
}

void LeController::SetInquiryLAP(uint64_t lap) { inquiry_lap_ = lap; }

void LeController::SetInquiryMaxResponses(uint8_t max) { inquiry_max_responses_ = max; }

void LeController::Inquiry() {
...
void LeController::SetInquiryScanEnable(bool enable) { inquiry_scan_enable_ = enable; }

void LeController::SetPageScanEnable(bool enable) { page_scan_enable_ = enable; }

void LeController::SetPageTimeout(uint16_t page_timeout) { page_timeout_ = page_timeout; }

ErrorCode LeController::AddScoConnection(uint16_t connection_handle, uint16_t packet_type,
...
ErrorCode LeController::SetupSynchronousConnection(uint16_t connection_handle,
...
ErrorCode LeController::AcceptSynchronousConnection(Address bd_addr, uint32_t transmit_bandwidth,
...
ErrorCode LeController::RejectSynchronousConnection(Address bd_addr, uint16_t reason) {
...
TaskId LeController::StartScoStream(Address address) {
