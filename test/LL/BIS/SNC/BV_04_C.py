...
class Test(ControllerTest):
    ...
    # LL/BIS/SNC/BV-04-C [Broadcast Isochronous Stream Termination - Address Resolution]
    # Conformance Rule: Tests that when peer sends LL_BIG_TERMINATE_IND with a source address (e.g. Controller Public Address)
    # different from the Advertiser's address, LeBigSyncLost is still immediately received by Synced Receiver.
    async def test(self):
        controller = self.controller
        advertiser_address = Address("11:11:11:11:11:11")
        ...
        # 5. Simulate Peer sending LL_BIG_TERMINATE_IND Link Layer Packet with raw RPA/Advertiser Address
        controller.send_ll(
